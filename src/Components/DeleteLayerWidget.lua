...
local function DeleteLayerWidget(props)
	return Roact.createElement(Widget, {
		Id = "deleteLayerWidget",
		Name = "deleteLayerWidget",
		Title = props.Title,
		...
		Label = Roact.createElement(Label, {
			...
			Text = string.format("Are you sure you want to delete the layer '%s'?", props.LayerName),
			TextWrapped = true,
